...
Computed<ColorScheme> cFlexSchemeLight = computed(() {
  if (sIsGreen.value) {
    return const ColorScheme(
      ...
      surfaceContainerHighest: Color(0xffdbdfd9),
    ...
    return const ColorScheme(
      ...
      surfaceContainerHighest: Color(0xffe9dbd8),
...
Computed<ColorScheme> cFlexSchemeDark = computed(() {
  if (sIsGreen.value) {
    return const ColorScheme(
      ...
      surfaceContainerHighest: Color(0xff303832),
    ...
    return const ColorScheme(
      ...
      surfaceContainerHighest: Color(0xff3f3331),
